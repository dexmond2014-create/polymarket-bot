...
//==================== TREND FILTER ================================
input bool             Use_Trend_Filter     = false;      // Enable trend filter
...
//==================== RISK MANAGEMENT ============================
input double           SL_Percent           = 1.0;        // Stop Loss (% of open price)
input double           TP_Percent           = 2.0;        // Take Profit (% of open price)
input double           Risk_Money           = 10.0;       // Risk per trade (fixed money amount)

//==================== TRAILING STOP =============================
input bool             Use_Trailing         = true;       // Enable trailing stop
input double           Trail_Activate_Pct   = 0.5;        // Activate after profit reaches (% of price)
